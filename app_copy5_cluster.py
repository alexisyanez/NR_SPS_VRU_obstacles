...
def main():
    ...
    fil_8 = df_7[(df_7['obstacles'] == False)]

    fil_9=plot_scatter4(fil_8,2)

    fil_44 = df_6[(df_6['min_cl'] == 5)]
    ...
    a=my_model(fil_10['All_indv_VRU_AVGPDR'], *optimized_params)
    #print(fil_10)
    ...
    a5=my_model(n_f9['All_indv_VRU_AVGPDR'], *optimized_params)
